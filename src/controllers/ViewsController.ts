...
class ViewsController {
	...
	public ugradnjaplina = (req: Request, res: Response, next: NextFunction) => {
		res.status(200).render('ugradnjaplina.pug');
	};

	public slep = (req: Request, res: Response, next: NextFunction) => {
		res.status(200).render('slep.pug');
	};

	public mehanika = (req: Request, res: Response, next: NextFunction) => {
		res.status(200).render('mehanika.pug');
	};

	public eknjizica = (req: Request, res: Response, next: NextFunction) => {
